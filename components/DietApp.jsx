...
const PROTEINS = [
  ...
  { n: "Atún en lata al natural", tags: ["P"], q: [60, 90, 90], note: "Máx. 7 latas/semana" },
  ...
  { n: "Pechuga de pollo", tags: ["P"], q: [110, 140, 160], custom: true },
  { n: "Conejo", tags: ["P"], q: [110, 140, 160], custom: true },
  { n: "Boquerones", tags: ["P", "G"], q: [140, 170, 200], custom: true },
  { n: "Requesón 0%", tags: ["P", "C"], q: [250, 250, 250], custom: true },
  { n: "Yogur proteínas natural 0% (50kcal/100g)", tags: ["P"], q: [150, 150, 150], custom: true },
  { n: "Edamame (con vaina)", tags: ["P", "C"], q: [150, 180, 210], custom: true },
  { n: "Tortas de arroz o maíz + fiambre de pollo o pavo", tags: ["P", "C"], q: ["30+60", "30+60", "30+60"], custom: true, note: "30 g tortas + 60 g fiambre" },
  { n: "Tortas de arroz o maíz + atún en lata al natural", tags: ["P", "C"], q: ["30+60", "30+60", "30+60"], custom: true, note: "30 g tortas + 60 g atún" },
  { n: "Quinoa + atún en lata al natural", tags: ["P", "C"], q: ["60+40", "60+40", "60+40"], custom: true, note: "60 g quinoa + 40 g atún" },
  { n: "Quinoa + fiambre de pollo o pavo", tags: ["P", "C"], q: ["60+40", "60+40", "60+40"], custom: true, note: "60 g quinoa + 40 g fiambre" },
  { n: "Avena + proteína en polvo", tags: ["P", "C"], q: ["60+10", "60+10", "60+10"], custom: true, note: "60 g avena + 10 g proteína" },
  { n: "Avena sin gluten + proteína en polvo", tags: ["P", "C"], q: ["60+10", "60+10", "60+10"], custom: true, note: "60 g avena + 10 g proteína" },
  { n: "Yogur griego light + avena + nueces", tags: ["P", "G", "C"], q: ["200+20+…", "200+20+…", "200+20+…"], custom: true, note: "200 g yogur + 20 g avena + nueces (cantidad de nueces no visible en la app)" },
  { n: "Yogur griego light + avena sin gluten + nueces", tags: ["P", "G", "C"], q: ["200+20+…", "200+20+…", "200+20+…"], custom: true, note: "200 g yogur + 20 g avena + nueces (cantidad de nueces no visible en la app)" },
  { n: "Yogur proteínas natural 0% + carbohidrato", tags: ["P", "C"], q: ["130+25", "130+25", "130+25"], custom: true, note: "130 g yogur + 25 g de un carbohidrato (detalle no visible en la app)" },
  // --- pescados y mariscos añadidos ---
  { n: "Bacaladilla", tags: ["P"], q: [150, 190, 220], custom: true },
  { n: "Gallo", tags: ["P"], q: [150, 190, 220], custom: true },
  { n: "Huachinango", tags: ["P"], q: [150, 150, 150], custom: true },
  { n: "Lenguado", tags: ["P"], q: [150, 190, 220], custom: true },
  { n: "Lubina", tags: ["P"], q: [150, 190, 220], custom: true },
  { n: "Rodaballo", tags: ["P"], q: [150, 190, 220], custom: true },
  { n: "Chopitos", tags: ["P"], q: [150, 190, 220], custom: true },
  { n: "Navajas", tags: ["P"], q: [120, 120, 120], custom: true },
  { n: "Pota", tags: ["P"], q: [150, 190, 220], custom: true },
  { n: "Pulpo cocido", tags: ["P"], q: [180, 180, 180], custom: true },
  { n: "Rejo cocido", tags: ["P"], q: [180, 180, 180], custom: true },
  { n: "Zamburiñas", tags: ["P"], q: [200, 200, 200], custom: true },
  // --- carnes añadidas ---
  { n: "Contramuslo deshuesado de pollo", tags: ["P"], q: [110, 140, 160], custom: true },
  { n: "Contramuslo deshuesado de pavo", tags: ["P"], q: [110, 140, 160], custom: true },
  { n: "Chuletas de pavo", tags: ["P"], q: [110, 140, 160], custom: true },
  { n: "Solomillo de pavo", tags: ["P"], q: [110, 140, 160], custom: true },
  { n: "Lomo de cerdo", tags: ["P", "G"], q: [120, 140, 180], custom: true, note: "Carne roja: máx. 3 raciones/semana" },
  { n: "Potro", tags: ["P"], q: [150, 150, 150], custom: true, note: "Máx. 3 raciones/semana" },
  { n: "Confit de pato", tags: ["P", "G"], q: [125, 125, 125], custom: true, note: "Máx. 3 raciones/semana" },
  // --- otros añadidos ---
  { n: "Heura", tags: ["P"], q: [150, 150, 150], custom: true },
  { n: "Proteína en polvo vegana", tags: ["P"], q: [30, 35, 40], custom: true },
  { n: "Queso fresco tipo Burgos 0%", tags: ["P"], q: [110, 110, 110], custom: true },
];

const CARBS = [
  { n: "Alubias en seco", tags: ["C", "P"], q: [70, 80, 90] },
  { n: "Arroz", tags: ["C"], q: [50, 60, 70] },
  { n: "Fideos de arroz", tags: ["C"], q: [50, 60, 70] },
  { n: "Noodles", tags: ["C"], q: [50, 60, 70] },
  { n: "Arroz inflado sin azúcares añadidos", tags: ["C"], q: [45, 55, 65] },
  { n: "Espelta inflada sin azúcares añadidos", tags: ["C"], q: [45, 55, 65] },
  { n: "Quinoa inflada sin azúcares añadidos", tags: ["C"], q: [45, 55, 65] },
  { n: "Batata / boniato", tags: ["C"], q: [160, 190, 230] },
  { n: "Corn flakes sin azúcares añadidos", tags: ["C"], q: [45, 55, 65] },
  { n: "Cous-Cous", tags: ["C"], q: [50, 60, 70] },
  { n: "Dátiles", tags: ["C"], q: [20, 25, 30], note: "Máx. 1 al día · mejor tras entrenar" },
  { n: "Dulce de leche", tags: ["C"], q: [30, 35, 40], note: "Máx. 1 al día · mejor tras entrenar" },
  ...
  { n: "Mermelada", tags: ["C"], q: [40, 45, 50], note: "Máx. 1 al día · mejor tras entrenar" },
  { n: "Miel", tags: ["C"], q: [25, 30, 35], note: "Máx. 1 al día · mejor tras entrenar" },
  { n: "Mijo", tags: ["C"], q: [50, 55, 70] },
  { n: "Polenta", tags: ["C"], q: [50, 55, 70] },
  { n: "Bulgur", tags: ["C"], q: [50, 55, 70] },
  ...
  // --- añadidos / confirmados en la app SpotEat ---
  { n: "Arroz blanco", tags: ["C"], q: [50, 60, 70], custom: true },
  { n: "Pasta blanca", tags: ["C"], q: [50, 60, 70], custom: true },
  { n: "Pasta sin gluten", tags: ["C"], q: [50, 60, 70], custom: true },
  { n: "Quinoa", tags: ["C"], q: [50, 60, 70], custom: true },
  { n: "Avena", tags: ["C"], q: [50, 60, 70], custom: true },
  { n: "Pan de molde integral", tags: ["C"], q: [70, 80, 90], custom: true },
  { n: "Pan sin gluten", tags: ["C"], q: [70, 80, 90], custom: true },
  { n: "Harinas sin gluten", tags: ["C"], q: [50, 60, 70], custom: true },
  { n: "Tortas de arroz", tags: ["C"], q: [50, 60, 70], custom: true },
  { n: "Tortas de maíz", tags: ["C"], q: [50, 60, 70], custom: true },
  { n: "Obleas de arroz", tags: ["C"], q: [50, 60, 70], custom: true },
  { n: "Tortillas de trigo (fajitas)", tags: ["C"], q: [60, 70, 80], custom: true },
  { n: "Tortillas de maíz sin gluten (fajitas)", tags: ["C"], q: [70, 80, 90], custom: true },
  { n: "Ñoquis sin gluten", tags: ["C"], q: [100, 120, 140], custom: true },
  { n: "Plátano macho", tags: ["C"], q: [190, 220, 250], custom: true },
  { n: "Patata de bote cocida", tags: ["C"], q: [320, 370, 420], custom: true },
  { n: "Puré de patatas (copos)", tags: ["C"], q: [50, 60, 70], custom: true },
  { n: "Papilla de arroz sin azúcares añadidos", tags: ["C"], q: [50, 60, 70], custom: true },
  { n: "Papilla de cereales sin azúcares añadidos", tags: ["C"], q: [50, 60, 70], custom: true },
  { n: "Papilla de cereales sin gluten sin azúcares añadidos", tags: ["C"], q: [50, 60, 70], custom: true },
  { n: "Dulce de membrillo", tags: ["C"], q: [35, 40, 45], custom: true, note: "Máx. 1 al día" },
  { n: "Leche condensada", tags: ["C"], q: [30, 35, 40], custom: true, note: "Máx. 1 al día" },
  { n: "Fruta deshidratada", tags: ["C"], q: [20, 25, 30], custom: true, note: "Máx. 1 al día" },
  { n: "Garbanzos cocidos (bote, escurridos)", tags: ["C", "P"], q: [260, 300, 340], custom: true },
  { n: "Alubias cocidas (bote, escurridas)", tags: ["C", "P"], q: [260, 300, 340], custom: true },
  { n: "Lentejas cocidas (bote, escurridas)", tags: ["C", "P"], q: [260, 300, 340], custom: true },
];
...
const FATS = [
  ...
  { n: "Hummus de garbanzo", tags: ["G"], q: [35, 35, 35] },
  ...
  { n: "Pipas de calabaza", tags: ["G"], q: [25, 25, 25], custom: true },
  { n: "Semillas de chía", tags: ["G"], q: [30, 30, 30], custom: true },
  { n: "Semillas de lino dorado", tags: ["G"], q: [25, 25, 25], custom: true },
  { n: "Coco rallado", tags: ["G"], q: [20, 20, 20], custom: true },
  { n: "Coco natural", tags: ["G"], q: [40, 40, 40], custom: true },
  { n: "Leche de coco en lata", tags: ["G"], q: [85, 85, 85], custom: true },
  { n: "Anacardos", tags: ["G"], q: [20, 20, 20], custom: true },
  { n: "Chocolate 85%", tags: ["G"], q: [20, 20, 20], custom: true },
  { n: "Turrón de almendras 0%", tags: ["G"], q: [30, 30, 30], custom: true },
  // --- lácteos grasos y frutos secos añadidos ---
  { n: "Queso azul", tags: ["G"], q: [40, 40, 40], custom: true },
  { n: "Queso de cabra", tags: ["G"], q: [40, 40, 40], custom: true },
  { n: "Queso curado", tags: ["G"], q: [30, 30, 30], custom: true },
  { n: "Nueces de brasil", tags: ["G"], q: [15, 15, 15], custom: true },
  { n: "Nueces pecanas", tags: ["G"], q: [15, 15, 15], custom: true },
  { n: "Piñones", tags: ["G"], q: [20, 20, 20], custom: true },
  { n: "Crema de pistacho 100%", tags: ["G"], q: [20, 20, 20], custom: true },
  { n: "Crema de almendras 100%", tags: ["G"], q: [20, 20, 20], custom: true },
  { n: "Crema de anacardos 100%", tags: ["G"], q: [20, 20, 20], custom: true },
  { n: "Crema de avellanas 100%", tags: ["G"], q: [15, 15, 15], custom: true },
  { n: "Crema de cacahuete 100%", tags: ["G"], q: [20, 20, 20], custom: true },
];
...
const FRUITS = [
  ...
  { n: "Sandía", q: 300 },
  { n: "Uvas", q: 150 },
  { n: "Pomelo", q: 300, custom: true },
  { n: "Granada", q: 160, custom: true },
  { n: "Lichis", q: 160, custom: true },
  { n: "Fruta de la pasión o maracuyá", q: 100, custom: true },
  { n: "Grosellas", q: 160, custom: true },
  { n: "Banana", q: 100, custom: true },
  { n: "Nectarinas", q: 230, custom: true },
  { n: "Paraguayo", q: 200, custom: true },
  { n: "Pitaya o dragon fruit", q: 200, custom: true },
].map((f) => ({ ...f, tags: ["F"] }));
